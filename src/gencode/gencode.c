...
int gencode_head_guard_begin(sstr_t head) {
    ...
    sstr_append_cstr(
        ...
        " * @param indent The indent space of json string.\n"
        " * @param curindent The current indent space of json string before calling "
        "this function, \n"
        " * set to 0 if you don't know what it means.\n"
        " * @param out The output json string.\n"
        " */\n"
